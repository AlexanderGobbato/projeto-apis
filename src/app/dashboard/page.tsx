  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      {projetos.map((projeto) => {
        ...
        return (
          <Link href={`/dashboard/projetos/${projeto.id}`} key={projeto.id} className="group flex flex-col bg-gray-800/40 hover:bg-gray-800/60 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 transition-all duration-300 hover:shadow-xl hover:shadow-blue-900/20 hover:-translate-y-1 relative overflow-hidden">
            ...
            <div className="relative z-10 flex-1">
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-2xl font-semibold text-white tracking-tight">{projeto.nome_projeto}</h3>
